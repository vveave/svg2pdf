...
fn get_svg_path(test_name: &str) -> PathBuf {
    PathBuf::from("svg").join(String::from(test_name) + ".svg")
}

fn run_test(test_name: &str) -> i32 {
...
#[test] fn resvg_filters_fe_displacement_map_simple_case() {assert_eq!(run_test("resvg/filters/feDisplacementMap/simple-case"), 0)}
#[test] fn resvg_filters_fe_offset_negative_offset() {assert_eq!(run_test("resvg/filters/feOffset/negative-offset"), 0)}
#[test] fn resvg_filters_fe_offset_fractional_offset() {assert_eq!(run_test("resvg/filters/feOffset/fractional-offset"), 0)}
#[test] fn resvg_filters_fe_offset_complex_transform() {assert_eq!(run_test("resvg/filters/feOffset/complex-transform"), 0)}
#[test] fn resvg_filters_fe_offset_no_offset() {assert_eq!(run_test("resvg/filters/feOffset/no-offset"), 0)}
#[test] fn resvg_filters_fe_offset_with_primitive_units_object_bounding_box() {assert_eq!(run_test("resvg/filters/feOffset/with-primitiveUnits=objectBoundingBox"), 0)}
#[test] fn resvg_filters_fe_offset_simple_case() {assert_eq!(run_test("resvg/filters/feOffset/simple-case"), 0)}
#[test] fn resvg_filters_fe_offset_only_dx() {assert_eq!(run_test("resvg/filters/feOffset/only-dx"), 0)}
#[test] fn resvg_filters_fe_offset_percentage_values() {assert_eq!(run_test("resvg/filters/feOffset/percentage-values"), 0)}
#[test] fn resvg_filters_fe_offset_only_dy() {assert_eq!(run_test("resvg/filters/feOffset/only-dy"), 0)}
#[test] fn resvg_filters_fe_color_matrix_invalid_type() {assert_eq!(run_test("resvg/filters/feColorMatrix/invalid-type"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_matrix() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=matrix"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_hue_rotate_without_an_angle() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=hueRotate-without-an-angle"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_saturate_without_a_coefficient() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=saturate-without-a-coefficient"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_hue_rotate() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=hueRotate"), 0)}
#[test] fn resvg_filters_fe_color_matrix_without_attributes() {assert_eq!(run_test("resvg/filters/feColorMatrix/without-attributes"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_matrix_without_values() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=matrix-without-values"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_saturate_with_negative_coefficient() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=saturate-with-negative-coefficient"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_luminance_to_alpha() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=luminanceToAlpha"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_matrix_with_too_many_values() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=matrix-with-too-many-values"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_matrix_with_non_normalized_values() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=matrix-with-non-normalized-values"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_saturate() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=saturate"), 0)}
#[test] fn resvg_filters_fe_color_matrix_without_a_type() {assert_eq!(run_test("resvg/filters/feColorMatrix/without-a-type"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_matrix_with_empty_values() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=matrix-with-empty-values"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_matrix_with_not_enough_values() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=matrix-with-not-enough-values"), 0)}
#[test] fn resvg_filters_fe_color_matrix_type_saturate_with_a_large_coefficient() {assert_eq!(run_test("resvg/filters/feColorMatrix/type=saturate-with-a-large-coefficient"), 0)}
#[test] fn resvg_filters_fe_blend_with_subregion_on_input_2() {assert_eq!(run_test("resvg/filters/feBlend/with-subregion-on-input-2"), 0)}
#[test] fn resvg_filters_fe_blend_mode_darken() {assert_eq!(run_test("resvg/filters/feBlend/mode=darken"), 0)}
#[test] fn resvg_filters_fe_blend_with_subregion_on_input_1() {assert_eq!(run_test("resvg/filters/feBlend/with-subregion-on-input-1"), 0)}
#[test] fn resvg_filters_fe_blend_mode_lighten() {assert_eq!(run_test("resvg/filters/feBlend/mode=lighten"), 0)}
#[test] fn resvg_filters_fe_blend_mode_screen() {assert_eq!(run_test("resvg/filters/feBlend/mode=screen"), 0)}
#[test] fn resvg_filters_fe_blend_mode_hue() {assert_eq!(run_test("resvg/filters/feBlend/mode=hue"), 0)}
#[test] fn resvg_filters_fe_blend_mode_color_burn() {assert_eq!(run_test("resvg/filters/feBlend/mode=color-burn"), 0)}
#[test] fn resvg_filters_fe_blend_mode_normal() {assert_eq!(run_test("resvg/filters/feBlend/mode=normal"), 0)}
#[test] fn resvg_filters_fe_blend_empty() {assert_eq!(run_test("resvg/filters/feBlend/empty"), 0)}
#[test] fn resvg_filters_fe_blend_mode_multiply() {assert_eq!(run_test("resvg/filters/feBlend/mode=multiply"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_with_large_values() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-with-large-values"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_on_blue_with_s_rgb_interpolation() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-on-blue-with-sRGB-interpolation"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_and_table_values_100_100() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-and-tableValues=100--100"), 0)}
#[test] fn resvg_filters_fe_component_transfer_invalid_type() {assert_eq!(run_test("resvg/filters/feComponentTransfer/invalid-type"), 0)}
#[test] fn resvg_filters_fe_component_transfer_mixed_types() {assert_eq!(run_test("resvg/filters/feComponentTransfer/mixed-types"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_linear_with_invalid_values() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=linear-with-invalid-values"), 0)}
#[test] fn resvg_filters_fe_component_transfer_no_children() {assert_eq!(run_test("resvg/filters/feComponentTransfer/no-children"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_and_table_values_1px() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-and-tableValues=1px"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_and_table_values_1_0_1() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-and-tableValues=1-0-1"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_linear_on_blue() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=linear-on-blue"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_without_table_values() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-without-tableValues"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_with_an_empty_table_values() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-with-an-empty-tableValues"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_identity_on_all() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=identity-on-all"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_discrete_on_blue() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=discrete-on-blue"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_gamma_with_invalid_values() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=gamma-with-invalid-values"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_on_blue_twice() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-on-blue-twice"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_gamma_with_an_invalid_offset() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=gamma-with-an-invalid-offset"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_gamma_on_blue() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=gamma-on-blue"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_on_blue() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-on-blue"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_on_alpha() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-on-alpha"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_table_and_table_values_1() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=table-and-tableValues=1"), 0)}
#[test] fn resvg_filters_fe_component_transfer_type_linear_with_large_values() {assert_eq!(run_test("resvg/filters/feComponentTransfer/type=linear-with-large-values"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_with_fe_spot_light_and_specular_and_exponent() {assert_eq!(run_test("resvg/filters/feSpecularLighting/with-feSpotLight-and-specular-and-exponent"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_with_fe_distant_light() {assert_eq!(run_test("resvg/filters/feSpecularLighting/with-feDistantLight"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_lighting_color_hsla() {assert_eq!(run_test("resvg/filters/feSpecularLighting/lighting-color=hsla"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_specular_exponent_256() {assert_eq!(run_test("resvg/filters/feSpecularLighting/specularExponent=256"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_with_fe_spot_light_and_specular_constant_5() {assert_eq!(run_test("resvg/filters/feSpecularLighting/with-feSpotLight-and-specularConstant=5"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_with_fe_point_light() {assert_eq!(run_test("resvg/filters/feSpecularLighting/with-fePointLight"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_specular_exponent_0() {assert_eq!(run_test("resvg/filters/feSpecularLighting/specularExponent=0"), 0)}
#[test] fn resvg_filters_fe_specular_lighting_with_fe_spot_light() {assert_eq!(run_test("resvg/filters/feSpecularLighting/with-feSpotLight"), 0)}
...
#[test] fn resvg_filters_fe_composite_with_subregion_on_input_2() {assert_eq!(run_test("resvg/filters/feComposite/with-subregion-on-input-2"), 0)}
#[test] fn resvg_filters_fe_composite_operator_xor() {assert_eq!(run_test("resvg/filters/feComposite/operator=xor"), 0)}
#[test] fn resvg_filters_fe_composite_operator_in() {assert_eq!(run_test("resvg/filters/feComposite/operator=in"), 0)}
#[test] fn resvg_filters_fe_composite_with_subregion_on_input_1() {assert_eq!(run_test("resvg/filters/feComposite/with-subregion-on-input-1"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic"), 0)}
#[test] fn resvg_filters_fe_composite_operator_over() {assert_eq!(run_test("resvg/filters/feComposite/operator=over"), 0)}
#[test] fn resvg_filters_fe_composite_operator_out() {assert_eq!(run_test("resvg/filters/feComposite/operator=out"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_with_opacity_on_s_rgb() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-with-opacity-on-sRGB"), 0)}
#[test] fn resvg_filters_fe_composite_empty() {assert_eq!(run_test("resvg/filters/feComposite/empty"), 0)}
#[test] fn resvg_filters_fe_composite_operator_atop() {assert_eq!(run_test("resvg/filters/feComposite/operator=atop"), 0)}
#[test] fn resvg_filters_fe_composite_invalid_operator() {assert_eq!(run_test("resvg/filters/feComposite/invalid-operator"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_with_large_k1_4() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-with-large-k1-4"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_with_some_k1_4() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-with-some-k1-4"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_without_k1_4() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-without-k1-4"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_and_invalid_k1_4() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-and-invalid-k1-4"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_on_s_rgb() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-on-sRGB"), 0)}
#[test] fn resvg_filters_fe_composite_default_operator() {assert_eq!(run_test("resvg/filters/feComposite/default-operator"), 0)}
#[test] fn resvg_filters_fe_composite_operator_arithmetic_with_opacity() {assert_eq!(run_test("resvg/filters/feComposite/operator=arithmetic-with-opacity"), 0)}
...
#[test] fn resvg_filters_filter_functions_drop_shadow_function_current_color() {assert_eq!(run_test("resvg/filters/filter-functions/drop-shadow-function-currentColor"), 0)}
...
#[test] fn resvg_filters_fe_tile_complex_transform() {assert_eq!(run_test("resvg/filters/feTile/complex-transform"), 0)}
#[test] fn resvg_filters_fe_tile_empty_region() {assert_eq!(run_test("resvg/filters/feTile/empty-region"), 0)}
#[test] fn resvg_filters_fe_tile_simple_case() {assert_eq!(run_test("resvg/filters/feTile/simple-case"), 0)}
#[test] fn resvg_filters_fe_tile_with_region() {assert_eq!(run_test("resvg/filters/feTile/with-region"), 0)}
#[test] fn resvg_filters_fe_tile_with_subregion_1() {assert_eq!(run_test("resvg/filters/feTile/with-subregion-1"), 0)}
#[test] fn resvg_filters_fe_tile_with_subregion_3() {assert_eq!(run_test("resvg/filters/feTile/with-subregion-3"), 0)}
#[test] fn resvg_filters_fe_tile_with_subregion_2() {assert_eq!(run_test("resvg/filters/feTile/with-subregion-2"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_std_deviation_with_multiple_values() {assert_eq!(run_test("resvg/filters/feGaussianBlur/stdDeviation-with-multiple-values"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_std_deviation_with_two_values() {assert_eq!(run_test("resvg/filters/feGaussianBlur/stdDeviation-with-two-values"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_small_std_deviation() {assert_eq!(run_test("resvg/filters/feGaussianBlur/small-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_std_deviation_5_0() {assert_eq!(run_test("resvg/filters/feGaussianBlur/stdDeviation=5-0"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_complex_transform() {assert_eq!(run_test("resvg/filters/feGaussianBlur/complex-transform"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_std_deviation_0_5() {assert_eq!(run_test("resvg/filters/feGaussianBlur/stdDeviation=0-5"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_negative_std_deviation() {assert_eq!(run_test("resvg/filters/feGaussianBlur/negative-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_simple_case() {assert_eq!(run_test("resvg/filters/feGaussianBlur/simple-case"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_no_std_deviation() {assert_eq!(run_test("resvg/filters/feGaussianBlur/no-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_std_deviation_with_two_different_values() {assert_eq!(run_test("resvg/filters/feGaussianBlur/stdDeviation-with-two-different-values"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_empty_std_deviation() {assert_eq!(run_test("resvg/filters/feGaussianBlur/empty-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_huge_std_deviation() {assert_eq!(run_test("resvg/filters/feGaussianBlur/huge-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_gaussian_blur_tiny_std_deviation() {assert_eq!(run_test("resvg/filters/feGaussianBlur/tiny-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_turbulence_base_frequency_0_05() {assert_eq!(run_test("resvg/filters/feTurbulence/baseFrequency=-0.05"), 0)}
#[test] fn resvg_filters_fe_turbulence_type_fractal_noise() {assert_eq!(run_test("resvg/filters/feTurbulence/type=fractalNoise"), 0)}
#[test] fn resvg_filters_fe_turbulence_complex_transform() {assert_eq!(run_test("resvg/filters/feTurbulence/complex-transform"), 0)}
#[test] fn resvg_filters_fe_turbulence_num_octaves_1() {assert_eq!(run_test("resvg/filters/feTurbulence/numOctaves=-1"), 0)}
#[test] fn resvg_filters_fe_turbulence_seed_1_5() {assert_eq!(run_test("resvg/filters/feTurbulence/seed=1.5"), 0)}
#[test] fn resvg_filters_fe_turbulence_no_attributes() {assert_eq!(run_test("resvg/filters/feTurbulence/no-attributes"), 0)}
#[test] fn resvg_filters_fe_turbulence_primitive_units_object_bounding_box() {assert_eq!(run_test("resvg/filters/feTurbulence/primitiveUnits=objectBoundingBox"), 0)}
#[test] fn resvg_filters_fe_turbulence_color_interpolation_filters_s_rgb() {assert_eq!(run_test("resvg/filters/feTurbulence/color-interpolation-filters=sRGB"), 0)}
#[test] fn resvg_filters_fe_turbulence_num_octaves_5() {assert_eq!(run_test("resvg/filters/feTurbulence/numOctaves=5"), 0)}
#[test] fn resvg_filters_fe_turbulence_num_octaves_0() {assert_eq!(run_test("resvg/filters/feTurbulence/numOctaves=0"), 0)}
#[test] fn resvg_filters_fe_turbulence_seed_20() {assert_eq!(run_test("resvg/filters/feTurbulence/seed=-20"), 0)}
#[test] fn resvg_filters_fe_turbulence_stitch_tiles_stitch() {assert_eq!(run_test("resvg/filters/feTurbulence/stitchTiles=stitch"), 0)}
#[test] fn resvg_filters_fe_turbulence_base_frequency_0_05_0() {assert_eq!(run_test("resvg/filters/feTurbulence/baseFrequency=0.05-0"), 0)}
#[test] fn resvg_filters_fe_turbulence_seed_20_93b8dbba() {assert_eq!(run_test("resvg/filters/feTurbulence/seed=20"), 0)}
#[test] fn resvg_filters_fe_turbulence_base_frequency_0_05_0_05() {assert_eq!(run_test("resvg/filters/feTurbulence/baseFrequency=0.05-0.05"), 0)}
#[test] fn resvg_filters_fe_turbulence_type_invalid() {assert_eq!(run_test("resvg/filters/feTurbulence/type=invalid"), 0)}
#[test] fn resvg_filters_fe_turbulence_base_frequency_0_01() {assert_eq!(run_test("resvg/filters/feTurbulence/baseFrequency=0.01"), 0)}
#[test] fn resvg_filters_fe_turbulence_base_frequency_0_05_0_01() {assert_eq!(run_test("resvg/filters/feTurbulence/baseFrequency=0.05-0.01"), 0)}
#[test] fn resvg_filters_fe_turbulence_base_frequency_0_05_0_01_c0de8288() {assert_eq!(run_test("resvg/filters/feTurbulence/baseFrequency=0.05--0.01"), 0)}
...
#[test] fn resvg_filters_fe_morphology_radius_10_1() {assert_eq!(run_test("resvg/filters/feMorphology/radius=10-1"), 0)}
#[test] fn resvg_filters_fe_morphology_source_with_opacity() {assert_eq!(run_test("resvg/filters/feMorphology/source-with-opacity"), 0)}
#[test] fn resvg_filters_fe_morphology_radius_10_0() {assert_eq!(run_test("resvg/filters/feMorphology/radius=10-0"), 0)}
#[test] fn resvg_filters_fe_morphology_empty_radius() {assert_eq!(run_test("resvg/filters/feMorphology/empty-radius"), 0)}
#[test] fn resvg_filters_fe_morphology_radius_0_5_with_object_bounding_box() {assert_eq!(run_test("resvg/filters/feMorphology/radius=0.5-with-objectBoundingBox"), 0)}
// will timeout CI
#[ignore] #[test] fn resvg_filters_fe_morphology_huge_radius() {assert_eq!(run_test("resvg/filters/feMorphology/huge-radius"), 0)}
#[test] fn resvg_filters_fe_morphology_operator_dilate() {assert_eq!(run_test("resvg/filters/feMorphology/operator=dilate"), 0)}
#[test] fn resvg_filters_fe_morphology_simple_case() {assert_eq!(run_test("resvg/filters/feMorphology/simple-case"), 0)}
#[test] fn resvg_filters_fe_morphology_radius_1_10() {assert_eq!(run_test("resvg/filters/feMorphology/radius=1-10"), 0)}
#[test] fn resvg_filters_fe_morphology_no_radius() {assert_eq!(run_test("resvg/filters/feMorphology/no-radius"), 0)}
#[test] fn resvg_filters_fe_morphology_radius_0_5() {assert_eq!(run_test("resvg/filters/feMorphology/radius=0.5"), 0)}
#[test] fn resvg_filters_fe_morphology_radius_with_too_many_values() {assert_eq!(run_test("resvg/filters/feMorphology/radius-with-too-many-values"), 0)}
#[test] fn resvg_filters_fe_morphology_negative_radius() {assert_eq!(run_test("resvg/filters/feMorphology/negative-radius"), 0)}
#[test] fn resvg_filters_fe_morphology_zero_radius() {assert_eq!(run_test("resvg/filters/feMorphology/zero-radius"), 0)}
#[test] fn resvg_filters_fe_merge_complex_transform() {assert_eq!(run_test("resvg/filters/feMerge/complex-transform"), 0)}
#[test] fn resvg_filters_fe_merge_color_interpolation_filters_linear_rgb() {assert_eq!(run_test("resvg/filters/feMerge/color-interpolation-filters=linearRGB"), 0)}
#[test] fn resvg_filters_fe_merge_color_interpolation_filters_s_rgb() {assert_eq!(run_test("resvg/filters/feMerge/color-interpolation-filters=sRGB"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_hsla_color() {assert_eq!(run_test("resvg/filters/feDropShadow/hsla-color"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_with_offset_clipped() {assert_eq!(run_test("resvg/filters/feDropShadow/with-offset-clipped"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_with_flood_opacity() {assert_eq!(run_test("resvg/filters/feDropShadow/with-flood-opacity"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_with_offset() {assert_eq!(run_test("resvg/filters/feDropShadow/with-offset"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_std_deviation_0() {assert_eq!(run_test("resvg/filters/feDropShadow/stdDeviation=0"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_only_std_deviation() {assert_eq!(run_test("resvg/filters/feDropShadow/only-stdDeviation"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_with_flood_color() {assert_eq!(run_test("resvg/filters/feDropShadow/with-flood-color"), 0)}
#[test] fn resvg_filters_fe_drop_shadow_with_percent_offset() {assert_eq!(run_test("resvg/filters/feDropShadow/with-percent-offset"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_order_4() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/order=4"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_order_with_a_negative_value_1() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/order-with-a-negative-value-1"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_edge_mode_none() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/edgeMode=none"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_kernel_matrix_with_not_enough_values() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/kernelMatrix-with-not-enough-values"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_order_with_a_negative_value_2() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/order-with-a-negative-value-2"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_order_0() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/order=0"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_bias_9999() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/bias=9999"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_edge_mode_wrap() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/edgeMode=wrap"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_edge_mode_wrap_with_matrix_larger_than_target() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/edgeMode=wrap-with-matrix-larger-than-target"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_divisor_0() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/divisor=0"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_target_x_2() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/targetX=2"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_kernel_matrix_with_zero_sum_and_no_divisor() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/kernelMatrix-with-zero-sum-and-no-divisor"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_target_x_3() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/targetX=3"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_empty_kernel_matrix() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/empty-kernelMatrix"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_unset_order() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/unset-order"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_target_x_0() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/targetX=0"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_bias_0_5() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/bias=0.5"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_target_x_1() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/targetX=-1"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_order_4_4() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/order=4-4"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_custom_divisor() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/custom-divisor"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_no_kernel_matrix() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/no-kernelMatrix"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_preserve_alpha_true() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/preserveAlpha=true"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_bias_0_5_7dbb95bc() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/bias=-0.5"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_kernel_matrix_with_too_many_values() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/kernelMatrix-with-too-many-values"), 0)}
#[test] fn resvg_filters_fe_convolve_matrix_order_4_2() {assert_eq!(run_test("resvg/filters/feConvolveMatrix/order=4-2"), 0)}
...
#[test] fn resvg_filters_fe_distant_light_negative_azimuth_and_elevation() {assert_eq!(run_test("resvg/filters/feDistantLight/negative-azimuth-and-elevation"), 0)}
#[test] fn resvg_filters_fe_distant_light_only_azimuth() {assert_eq!(run_test("resvg/filters/feDistantLight/only-azimuth"), 0)}
#[test] fn resvg_filters_fe_distant_light_only_elevation() {assert_eq!(run_test("resvg/filters/feDistantLight/only-elevation"), 0)}
#[test] fn resvg_filters_fe_distant_light_default_attributes() {assert_eq!(run_test("resvg/filters/feDistantLight/default-attributes"), 0)}
#[test] fn resvg_filters_fe_point_light_complex_transform() {assert_eq!(run_test("resvg/filters/fePointLight/complex-transform"), 0)}
#[test] fn resvg_filters_fe_point_light_primitive_units_object_bounding_box() {assert_eq!(run_test("resvg/filters/fePointLight/primitiveUnits=objectBoundingBox"), 0)}
#[test] fn resvg_filters_fe_point_light_custom_attributes() {assert_eq!(run_test("resvg/filters/fePointLight/custom-attributes"), 0)}
#[test] fn resvg_filters_fe_point_light_default_attributes() {assert_eq!(run_test("resvg/filters/fePointLight/default-attributes"), 0)}
...
#[test] fn resvg_filters_filter_with_region_and_filter_units_user_space_on_use() {assert_eq!(run_test("resvg/filters/filter/with-region-and-filterUnits=userSpaceOnUse"), 0)}
#[test] fn resvg_filters_filter_in_background_alpha_with_enable_background() {assert_eq!(run_test("resvg/filters/filter/in=BackgroundAlpha-with-enable-background"), 0)}
#[test] fn resvg_filters_filter_in_stroke_paint() {assert_eq!(run_test("resvg/filters/filter/in=StrokePaint"), 0)}
...
#[test] fn resvg_filters_filter_in_background_alpha() {assert_eq!(run_test("resvg/filters/filter/in=BackgroundAlpha"), 0)}
...
#[test] fn resvg_filters_filter_in_background_image_with_enable_background() {assert_eq!(run_test("resvg/filters/filter/in=BackgroundImage-with-enable-background"), 0)}
...
#[test] fn resvg_filters_filter_in_fill_paint_with_gradient() {assert_eq!(run_test("resvg/filters/filter/in=FillPaint-with-gradient"), 0)}
#[test] fn resvg_filters_filter_in_fill_paint_with_pattern() {assert_eq!(run_test("resvg/filters/filter/in=FillPaint-with-pattern"), 0)}
...
#[test] fn resvg_filters_filter_subregion_and_primitive_units_object_bounding_box_2() {assert_eq!(run_test("resvg/filters/filter/subregion-and-primitiveUnits=objectBoundingBox-2"), 0)}
...
#[test] fn resvg_filters_filter_primitive_units_object_bounding_box() {assert_eq!(run_test("resvg/filters/filter/primitiveUnits=objectBoundingBox"), 0)}
#[test] fn resvg_filters_filter_color_interpolation_filters_s_rgb() {assert_eq!(run_test("resvg/filters/filter/color-interpolation-filters=sRGB"), 0)}
#[test] fn resvg_filters_filter_with_region() {assert_eq!(run_test("resvg/filters/filter/with-region"), 0)}
#[test] fn resvg_filters_filter_subregion_and_primitive_units_object_bounding_box_1() {assert_eq!(run_test("resvg/filters/filter/subregion-and-primitiveUnits=objectBoundingBox-1"), 0)}
#[test] fn resvg_filters_filter_in_fill_paint_with_target_on_g() {assert_eq!(run_test("resvg/filters/filter/in=FillPaint-with-target-on-g"), 0)}
#[test] fn resvg_filters_filter_in_fill_paint() {assert_eq!(run_test("resvg/filters/filter/in=FillPaint"), 0)}
#[test] fn resvg_filters_filter_negative_subregion() {assert_eq!(run_test("resvg/filters/filter/negative-subregion"), 0)}
#[test] fn resvg_filters_filter_in_fill_paint_on_g_without_children() {assert_eq!(run_test("resvg/filters/filter/in=FillPaint-on-g-without-children"), 0)}
#[test] fn resvg_filters_filter_with_mask() {assert_eq!(run_test("resvg/filters/filter/with-mask"), 0)}
#[test] fn resvg_filters_filter_invalid_filter_units() {assert_eq!(run_test("resvg/filters/filter/invalid-filterUnits"), 0)}
...
#[test] fn resvg_filters_filter_invalid_func_iri() {assert_eq!(run_test("resvg/filters/filter/invalid-FuncIRI"), 0)}
#[test] fn resvg_filters_filter_multiple_primitives_4() {assert_eq!(run_test("resvg/filters/filter/multiple-primitives-4"), 0)}
#[test] fn resvg_filters_filter_in_background_image() {assert_eq!(run_test("resvg/filters/filter/in=BackgroundImage"), 0)}
...
#[test] fn resvg_filters_filter_without_region_and_filter_units_user_space_on_use() {assert_eq!(run_test("resvg/filters/filter/without-region-and-filterUnits=userSpaceOnUse"), 0)}
#[test] fn resvg_filters_filter_multiple_primitives_2() {assert_eq!(run_test("resvg/filters/filter/multiple-primitives-2"), 0)}
#[test] fn resvg_filters_fe_image_link_to_use() {assert_eq!(run_test("resvg/filters/feImage/link-to-use"), 0)}
#[test] fn resvg_filters_fe_image_link_to_g() {assert_eq!(run_test("resvg/filters/feImage/link-to-g"), 0)}
#[test] fn resvg_filters_fe_image_empty() {assert_eq!(run_test("resvg/filters/feImage/empty"), 0)}
#[test] fn resvg_filters_fe_image_link_to_an_element_with_transform() {assert_eq!(run_test("resvg/filters/feImage/link-to-an-element-with-transform"), 0)}
#[test] fn resvg_filters_fe_image_with_x_y() {assert_eq!(run_test("resvg/filters/feImage/with-x-y"), 0)}
#[test] fn resvg_filters_fe_image_link_to_an_invalid_element() {assert_eq!(run_test("resvg/filters/feImage/link-to-an-invalid-element"), 0)}
#[test] fn resvg_filters_fe_image_link_on_an_element_with_transform() {assert_eq!(run_test("resvg/filters/feImage/link-on-an-element-with-transform"), 0)}
#[test] fn resvg_filters_fe_image_embedded_png() {assert_eq!(run_test("resvg/filters/feImage/embedded-png"), 0)}
// no relative paths supported
#[ignore] #[test] fn resvg_filters_fe_image_simple_case() {assert_eq!(run_test("resvg/filters/feImage/simple-case"), 0)}
#[test] fn resvg_filters_fe_image_with_x_y_and_protruding_subregion_2() {assert_eq!(run_test("resvg/filters/feImage/with-x-y-and-protruding-subregion-2"), 0)}
#[test] fn resvg_filters_fe_image_with_x_y_and_protruding_subregion_1() {assert_eq!(run_test("resvg/filters/feImage/with-x-y-and-protruding-subregion-1"), 0)}
#[test] fn resvg_filters_fe_image_with_subregion_5() {assert_eq!(run_test("resvg/filters/feImage/with-subregion-5"), 0)}
#[test] fn resvg_filters_fe_image_link_to_an_element_with_opacity() {assert_eq!(run_test("resvg/filters/feImage/link-to-an-element-with-opacity"), 0)}
#[test] fn resvg_filters_fe_image_preserve_aspect_ratio_none() {assert_eq!(run_test("resvg/filters/feImage/preserveAspectRatio=none"), 0)}
#[test] fn resvg_filters_fe_image_with_subregion_4() {assert_eq!(run_test("resvg/filters/feImage/with-subregion-4"), 0)}
#[test] fn resvg_filters_fe_image_svg() {assert_eq!(run_test("resvg/filters/feImage/svg"), 0)}
#[test] fn resvg_filters_fe_image_with_subregion_1() {assert_eq!(run_test("resvg/filters/feImage/with-subregion-1"), 0)}
#[test] fn resvg_filters_fe_image_link_on_an_element_with_complex_transform() {assert_eq!(run_test("resvg/filters/feImage/link-on-an-element-with-complex-transform"), 0)}
#[test] fn resvg_filters_fe_image_with_subregion_3() {assert_eq!(run_test("resvg/filters/feImage/with-subregion-3"), 0)}
#[test] fn resvg_filters_fe_image_link_to_an_element() {assert_eq!(run_test("resvg/filters/feImage/link-to-an-element"), 0)}
#[test] fn resvg_filters_fe_image_with_subregion_2() {assert_eq!(run_test("resvg/filters/feImage/with-subregion-2"), 0)}
#[test] fn resvg_filters_fe_image_chained_fe_image() {assert_eq!(run_test("resvg/filters/feImage/chained-feImage"), 0)}
#[test] fn resvg_filters_fe_image_self_recursive() {assert_eq!(run_test("resvg/filters/feImage/self-recursive"), 0)}
#[test] fn resvg_filters_fe_image_link_to_an_element_outside_defs_1() {assert_eq!(run_test("resvg/filters/feImage/link-to-an-element-outside-defs-1"), 0)}
#[test] fn resvg_filters_fe_image_recursive_links_2() {assert_eq!(run_test("resvg/filters/feImage/recursive-links-2"), 0)}
#[test] fn resvg_filters_fe_image_link_to_an_element_outside_defs_2() {assert_eq!(run_test("resvg/filters/feImage/link-to-an-element-outside-defs-2"), 0)}
#[test] fn resvg_filters_fe_image_recursive_links_1() {assert_eq!(run_test("resvg/filters/feImage/recursive-links-1"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_single_light_source() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/single-light-source"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_single_light_source_with_desc() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/single-light-source-with-desc"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_lighting_color_inherit() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/lighting-color=inherit"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_lighting_color_hsla() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/lighting-color=hsla"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_single_light_source_with_title_and_desc() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/single-light-source-with-title-and-desc"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_single_light_source_with_invalid_child() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/single-light-source-with-invalid-child"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_complex_transform() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/complex-transform"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_lighting_color_current_color() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/lighting-color=currentColor"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_surface_scale_1_33() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/surfaceScale=1.33"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_no_light_source() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/no-light-source"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_diffuse_constant_1() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/diffuseConstant=-1"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_surface_scale_5() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/surfaceScale=5"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_surface_scale_10() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/surfaceScale=-10"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_single_light_source_with_title() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/single-light-source-with-title"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_surface_scale_0() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/surfaceScale=0"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_lighting_color_seagreen() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/lighting-color=seagreen"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_linear_rgb_color_interpolation() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/linearRGB-color-interpolation"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_diffuse_constant_0() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/diffuseConstant=0"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_single_light_source_with_comment() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/single-light-source-with-comment"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_lighting_color_current_color_without_color() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/lighting-color=currentColor-without-color"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_multiple_light_sources() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/multiple-light-sources"), 0)}
#[test] fn resvg_filters_fe_diffuse_lighting_diffuse_constant_5() {assert_eq!(run_test("resvg/filters/feDiffuseLighting/diffuseConstant=5"), 0)}
#[test] fn resvg_filters_fe_flood_complex_transform() {assert_eq!(run_test("resvg/filters/feFlood/complex-transform"), 0)}
#[test] fn resvg_filters_fe_flood_with_opacity_on_target_element() {assert_eq!(run_test("resvg/filters/feFlood/with-opacity-on-target-element"), 0)}
#[test] fn resvg_filters_fe_flood_with_opacity() {assert_eq!(run_test("resvg/filters/feFlood/with-opacity"), 0)}
#[test] fn resvg_filters_fe_flood_subregion_with_primitive_units_object_bounding_box() {assert_eq!(run_test("resvg/filters/feFlood/subregion-with-primitiveUnits=objectBoundingBox"), 0)}
#[test] fn resvg_filters_fe_flood_default_values() {assert_eq!(run_test("resvg/filters/feFlood/default-values"), 0)}
#[test] fn resvg_filters_fe_flood_partial_subregion() {assert_eq!(run_test("resvg/filters/feFlood/partial-subregion"), 0)}
#[test] fn resvg_filters_fe_flood_seagreen() {assert_eq!(run_test("resvg/filters/feFlood/seagreen"), 0)}
#[test] fn resvg_filters_fe_flood_subregion_inheritance() {assert_eq!(run_test("resvg/filters/feFlood/subregion-inheritance"), 0)}
#[test] fn resvg_filters_fe_spot_light_with_all_points_at() {assert_eq!(run_test("resvg/filters/feSpotLight/with-all-pointsAt"), 0)}
#[test] fn resvg_filters_fe_spot_light_complex_transform() {assert_eq!(run_test("resvg/filters/feSpotLight/complex-transform"), 0)}
#[test] fn resvg_filters_fe_spot_light_limiting_cone_angle_0() {assert_eq!(run_test("resvg/filters/feSpotLight/limitingConeAngle=0"), 0)}
#[test] fn resvg_filters_fe_spot_light_primitive_units_object_bounding_box() {assert_eq!(run_test("resvg/filters/feSpotLight/primitiveUnits=objectBoundingBox"), 0)}
#[test] fn resvg_filters_fe_spot_light_limiting_cone_angle_anti_aliasing() {assert_eq!(run_test("resvg/filters/feSpotLight/limitingConeAngle-anti-aliasing"), 0)}
#[test] fn resvg_filters_fe_spot_light_specular_exponent_10() {assert_eq!(run_test("resvg/filters/feSpotLight/specularExponent=10"), 0)}
#[test] fn resvg_filters_fe_spot_light_specular_exponent_10_2d3fa861() {assert_eq!(run_test("resvg/filters/feSpotLight/specularExponent=-10"), 0)}
#[test] fn resvg_filters_fe_spot_light_custom_attributes() {assert_eq!(run_test("resvg/filters/feSpotLight/custom-attributes"), 0)}
#[test] fn resvg_filters_fe_spot_light_specular_exponent_0_5() {assert_eq!(run_test("resvg/filters/feSpotLight/specularExponent=0.5"), 0)}
#[test] fn resvg_filters_fe_spot_light_limiting_cone_angle_30() {assert_eq!(run_test("resvg/filters/feSpotLight/limitingConeAngle=30"), 0)}
#[test] fn resvg_filters_fe_spot_light_limiting_cone_angle_30_38c9e0ef() {assert_eq!(run_test("resvg/filters/feSpotLight/limitingConeAngle=-30"), 0)}
#[test] fn resvg_filters_fe_spot_light_default_attributes() {assert_eq!(run_test("resvg/filters/feSpotLight/default-attributes"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fy_resolving_1() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fy-resolving-1"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fy_resolving_2() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fy-resolving-2"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fy_resolving_3() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fy-resolving-3"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_hsla_color() {assert_eq!(run_test("resvg/paint-servers/radialGradient/hsla-color"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_attributes_via_xlink_href_only_required() {assert_eq!(run_test("resvg/paint-servers/radialGradient/attributes-via-xlink-href-only-required"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_attributes_via_xlink_href() {assert_eq!(run_test("resvg/paint-servers/radialGradient/attributes-via-xlink-href"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_gradient_transform_and_transform() {assert_eq!(run_test("resvg/paint-servers/radialGradient/gradientTransform-and-transform"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_stops_via_xlink_href() {assert_eq!(run_test("resvg/paint-servers/radialGradient/stops-via-xlink-href"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fr_1() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fr=-1"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_no_stops() {assert_eq!(run_test("resvg/paint-servers/radialGradient/no-stops"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fr_0_2() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fr=0.2"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_spread_method_pad() {assert_eq!(run_test("resvg/paint-servers/radialGradient/spreadMethod=pad"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_invalid_gradient_units() {assert_eq!(run_test("resvg/paint-servers/radialGradient/invalid-gradientUnits"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_gradient_units_object_bounding_box_with_percent() {assert_eq!(run_test("resvg/paint-servers/radialGradient/gradientUnits=objectBoundingBox-with-percent"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_invalid_spread_method() {assert_eq!(run_test("resvg/paint-servers/radialGradient/invalid-spreadMethod"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fr_0_5() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fr=0.5"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fx_resolving_1() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fx-resolving-1"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_stops_via_xlink_href_from_linear_gradient() {assert_eq!(run_test("resvg/paint-servers/radialGradient/stops-via-xlink-href-from-linearGradient"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_many_stops() {assert_eq!(run_test("resvg/paint-servers/radialGradient/many-stops"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fx_resolving_2() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fx-resolving-2"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fx_resolving_3() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fx-resolving-3"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_fr_0_7() {assert_eq!(run_test("resvg/paint-servers/radialGradient/fr=0.7"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_gradient_transform() {assert_eq!(run_test("resvg/paint-servers/radialGradient/gradientTransform"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_gradient_units_user_space_on_use() {assert_eq!(run_test("resvg/paint-servers/radialGradient/gradientUnits=userSpaceOnUse"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_zero_r_with_stop_opacity_2() {assert_eq!(run_test("resvg/paint-servers/radialGradient/zero-r-with-stop-opacity-2"), 0)}
// spreadMethod reflect not supported
#[ignore] #[test] fn resvg_paint_servers_radial_gradient_attributes_via_xlink_href_from_linear_gradient() {assert_eq!(run_test("resvg/paint-servers/radialGradient/attributes-via-xlink-href-from-linearGradient"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_zero_r_with_stop_opacity_1() {assert_eq!(run_test("resvg/paint-servers/radialGradient/zero-r-with-stop-opacity-1"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_stops_via_xlink_href_complex_order() {assert_eq!(run_test("resvg/paint-servers/radialGradient/stops-via-xlink-href-complex-order"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_single_stop() {assert_eq!(run_test("resvg/paint-servers/radialGradient/single-stop"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_invalid_gradient_transform() {assert_eq!(run_test("resvg/paint-servers/radialGradient/invalid-gradientTransform"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_stops_via_xlink_href_from_rect() {assert_eq!(run_test("resvg/paint-servers/radialGradient/stops-via-xlink-href-from-rect"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_zero_r() {assert_eq!(run_test("resvg/paint-servers/radialGradient/zero-r"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_recursive_xlink_href() {assert_eq!(run_test("resvg/paint-servers/radialGradient/recursive-xlink-href"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_negative_r() {assert_eq!(run_test("resvg/paint-servers/radialGradient/negative-r"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_focal_point_correction() {assert_eq!(run_test("resvg/paint-servers/radialGradient/focal-point-correction"), 0)}
// spreadMethod repeat not supported
#[ignore] #[test] fn resvg_paint_servers_radial_gradient_spread_method_repeat() {assert_eq!(run_test("resvg/paint-servers/radialGradient/spreadMethod=repeat"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_unresolved_xlink_href() {assert_eq!(run_test("resvg/paint-servers/radialGradient/unresolved-xlink-href"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_invalid_xlink_href() {assert_eq!(run_test("resvg/paint-servers/radialGradient/invalid-xlink-href"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_attributes_via_xlink_href_from_rect() {assert_eq!(run_test("resvg/paint-servers/radialGradient/attributes-via-xlink-href-from-rect"), 0)}
// spreadMethod reflect not supported
#[ignore] #[test] fn resvg_paint_servers_radial_gradient_attributes_via_xlink_href_complex_order() {assert_eq!(run_test("resvg/paint-servers/radialGradient/attributes-via-xlink-href-complex-order"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_xlink_href_not_to_gradient() {assert_eq!(run_test("resvg/paint-servers/radialGradient/xlink-href-not-to-gradient"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_gradient_units_user_space_on_use_with_percent() {assert_eq!(run_test("resvg/paint-servers/radialGradient/gradientUnits=userSpaceOnUse-with-percent"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_self_recursive_xlink_href() {assert_eq!(run_test("resvg/paint-servers/radialGradient/self-recursive-xlink-href"), 0)}
// spreadMethod reflect not supported
#[ignore] #[test] fn resvg_paint_servers_radial_gradient_spread_method_reflect() {assert_eq!(run_test("resvg/paint-servers/radialGradient/spreadMethod=reflect"), 0)}
#[test] fn resvg_paint_servers_radial_gradient_default_attributes() {assert_eq!(run_test("resvg/paint-servers/radialGradient/default-attributes"), 0)}
...
#[test] fn resvg_paint_servers_stop_stop_color_with_current_color_2() {assert_eq!(run_test("resvg/paint-servers/stop/stop-color-with-currentColor-2"), 0)}
#[test] fn resvg_paint_servers_stop_stop_color_with_current_color_3() {assert_eq!(run_test("resvg/paint-servers/stop/stop-color-with-currentColor-3"), 0)}
#[test] fn resvg_paint_servers_stop_missing_offset_2() {assert_eq!(run_test("resvg/paint-servers/stop/missing-offset-2"), 0)}
#[test] fn resvg_paint_servers_stop_stop_color_with_current_color_1() {assert_eq!(run_test("resvg/paint-servers/stop/stop-color-with-currentColor-1"), 0)}
...
#[test] fn resvg_paint_servers_stop_stop_color_with_current_color_4() {assert_eq!(run_test("resvg/paint-servers/stop/stop-color-with-currentColor-4"), 0)}
...
#[test] fn resvg_paint_servers_linear_gradient_hsla_color() {assert_eq!(run_test("resvg/paint-servers/linearGradient/hsla-color"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_attributes_via_xlink_href_only_required() {assert_eq!(run_test("resvg/paint-servers/linearGradient/attributes-via-xlink-href-only-required"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_attributes_via_xlink_href() {assert_eq!(run_test("resvg/paint-servers/linearGradient/attributes-via-xlink-href"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_gradient_transform_and_transform() {assert_eq!(run_test("resvg/paint-servers/linearGradient/gradientTransform-and-transform"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_stops_via_xlink_href() {assert_eq!(run_test("resvg/paint-servers/linearGradient/stops-via-xlink-href"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_no_stops() {assert_eq!(run_test("resvg/paint-servers/linearGradient/no-stops"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_child_3() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-child-3"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_child_2() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-child-2"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_spread_method_pad() {assert_eq!(run_test("resvg/paint-servers/linearGradient/spreadMethod=pad"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_gradient_units() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-gradientUnits"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_stops_via_xlink_href_complex_order_2() {assert_eq!(run_test("resvg/paint-servers/linearGradient/stops-via-xlink-href-complex-order-2"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_child_1() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-child-1"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_gradient_units_object_bounding_box_with_percent() {assert_eq!(run_test("resvg/paint-servers/linearGradient/gradientUnits=objectBoundingBox-with-percent"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_spread_method() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-spreadMethod"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_stops_via_xlink_href_complex_order_1() {assert_eq!(run_test("resvg/paint-servers/linearGradient/stops-via-xlink-href-complex-order-1"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_many_stops() {assert_eq!(run_test("resvg/paint-servers/linearGradient/many-stops"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_single_stop_with_opacity_used_by_fill() {assert_eq!(run_test("resvg/paint-servers/linearGradient/single-stop-with-opacity-used-by-fill"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_stops_via_xlink_href_from_radial_gradient() {assert_eq!(run_test("resvg/paint-servers/linearGradient/stops-via-xlink-href-from-radialGradient"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_gradient_transform() {assert_eq!(run_test("resvg/paint-servers/linearGradient/gradientTransform"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_gradient_units_user_space_on_use() {assert_eq!(run_test("resvg/paint-servers/linearGradient/gradientUnits=userSpaceOnUse"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_recursive_xlink_href_3() {assert_eq!(run_test("resvg/paint-servers/linearGradient/recursive-xlink-href-3"), 0)}
// spreadMethod reflect not supported
#[ignore] #[test] fn resvg_paint_servers_linear_gradient_attributes_via_xlink_href_from_radial_gradient() {assert_eq!(run_test("resvg/paint-servers/linearGradient/attributes-via-xlink-href-from-radialGradient"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_recursive_xlink_href_2() {assert_eq!(run_test("resvg/paint-servers/linearGradient/recursive-xlink-href-2"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_recursive_xlink_href_1() {assert_eq!(run_test("resvg/paint-servers/linearGradient/recursive-xlink-href-1"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_single_stop_with_opacity_used_by_stroke() {assert_eq!(run_test("resvg/paint-servers/linearGradient/single-stop-with-opacity-used-by-stroke"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_single_stop() {assert_eq!(run_test("resvg/paint-servers/linearGradient/single-stop"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_gradient_transform() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-gradientTransform"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_stops_via_xlink_href_from_rect() {assert_eq!(run_test("resvg/paint-servers/linearGradient/stops-via-xlink-href-from-rect"), 0)}
// spreadMethod repeat not supported
#[ignore] #[test] fn resvg_paint_servers_linear_gradient_spread_method_repeat() {assert_eq!(run_test("resvg/paint-servers/linearGradient/spreadMethod=repeat"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_unresolved_xlink_href() {assert_eq!(run_test("resvg/paint-servers/linearGradient/unresolved-xlink-href"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_invalid_xlink_href() {assert_eq!(run_test("resvg/paint-servers/linearGradient/invalid-xlink-href"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_attributes_via_xlink_href_from_rect() {assert_eq!(run_test("resvg/paint-servers/linearGradient/attributes-via-xlink-href-from-rect"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_single_stop_with_opacity_used_by_fill_and_stroke() {assert_eq!(run_test("resvg/paint-servers/linearGradient/single-stop-with-opacity-used-by-fill-and-stroke"), 0)}
// spreadMethod reflect not supported
#[ignore] #[test] fn resvg_paint_servers_linear_gradient_attributes_via_xlink_href_complex_order() {assert_eq!(run_test("resvg/paint-servers/linearGradient/attributes-via-xlink-href-complex-order"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_gradient_units_user_space_on_use_with_percent() {assert_eq!(run_test("resvg/paint-servers/linearGradient/gradientUnits=userSpaceOnUse-with-percent"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_self_recursive_xlink_href() {assert_eq!(run_test("resvg/paint-servers/linearGradient/self-recursive-xlink-href"), 0)}
// spreadMethod reflect not supported
#[ignore] #[test] fn resvg_paint_servers_linear_gradient_spread_method_reflect() {assert_eq!(run_test("resvg/paint-servers/linearGradient/spreadMethod=reflect"), 0)}
#[test] fn resvg_paint_servers_linear_gradient_default_attributes() {assert_eq!(run_test("resvg/paint-servers/linearGradient/default-attributes"), 0)}
...
#[test] fn resvg_paint_servers_pattern_transform_and_pattern_transform() {assert_eq!(run_test("resvg/paint-servers/pattern/transform-and-patternTransform"), 0)}
...
#[test] fn resvg_paint_servers_pattern_pattern_units_user_space_on_use_with_percent() {assert_eq!(run_test("resvg/paint-servers/pattern/patternUnits=userSpaceOnUse-with-percent"), 0)}
#[test] fn resvg_paint_servers_pattern_with_view_box() {assert_eq!(run_test("resvg/paint-servers/pattern/with-viewBox"), 0)}
...
#[test] fn resvg_paint_servers_pattern_pattern_content_units_object_bounding_box() {assert_eq!(run_test("resvg/paint-servers/pattern/patternContentUnits=objectBoundingBox"), 0)}
#[test] fn resvg_paint_servers_pattern_pattern_units_object_bounding_box_with_percent() {assert_eq!(run_test("resvg/paint-servers/pattern/patternUnits=objectBoundingBox-with-percent"), 0)}
#[test] fn resvg_paint_servers_pattern_pattern_content_units_with_view_box() {assert_eq!(run_test("resvg/paint-servers/pattern/patternContentUnits-with-viewBox"), 0)}
...
#[test] fn resvg_paint_servers_pattern_with_pattern_transform() {assert_eq!(run_test("resvg/paint-servers/pattern/with-patternTransform"), 0)}
#[test] fn resvg_paint_servers_pattern_with_x_and_y() {assert_eq!(run_test("resvg/paint-servers/pattern/with-x-and-y"), 0)}
#[test] fn resvg_paint_servers_pattern_nested_object_bounding_box() {assert_eq!(run_test("resvg/paint-servers/pattern/nested-objectBoundingBox"), 0)}
#[test] fn resvg_paint_servers_pattern_preserve_aspect_ratio() {assert_eq!(run_test("resvg/paint-servers/pattern/preserveAspectRatio"), 0)}
...
#[test] fn resvg_paint_servers_pattern_pattern_units_object_bounding_box() {assert_eq!(run_test("resvg/paint-servers/pattern/patternUnits=objectBoundingBox"), 0)}
...
#[test] fn resvg_paint_servers_pattern_invalid_pattern_units_and_pattern_content_units() {assert_eq!(run_test("resvg/paint-servers/pattern/invalid-patternUnits-and-patternContentUnits"), 0)}
...
#[test] fn resvg_paint_servers_pattern_child_with_invalid_func_iri() {assert_eq!(run_test("resvg/paint-servers/pattern/child-with-invalid-FuncIRI"), 0)}
...
#[test] fn resvg_paint_servers_pattern_invalid_pattern_transform() {assert_eq!(run_test("resvg/paint-servers/pattern/invalid-patternTransform"), 0)}
#[test] fn resvg_paint_servers_pattern_view_box_via_xlink_href() {assert_eq!(run_test("resvg/paint-servers/pattern/viewBox-via-xlink-href"), 0)}
...
#[test] fn resvg_painting_context_with_pattern_object_bounding_box_in_use() {assert_eq!(run_test("resvg/painting/context/with-pattern-objectBoundingBox-in-use"), 0)}
...
#[test] fn resvg_painting_shape_rendering_optimize_speed_on_text() {assert_eq!(run_test("resvg/painting/shape-rendering/optimizeSpeed-on-text"), 0)}
#[test] fn resvg_painting_shape_rendering_inheritance() {assert_eq!(run_test("resvg/painting/shape-rendering/inheritance"), 0)}
#[test] fn resvg_painting_shape_rendering_optimize_speed_on_circle() {assert_eq!(run_test("resvg/painting/shape-rendering/optimizeSpeed-on-circle"), 0)}
#[test] fn resvg_painting_shape_rendering_auto_on_circle() {assert_eq!(run_test("resvg/painting/shape-rendering/auto-on-circle"), 0)}
#[test] fn resvg_painting_shape_rendering_geometric_precision_on_circle() {assert_eq!(run_test("resvg/painting/shape-rendering/geometricPrecision-on-circle"), 0)}
#[test] fn resvg_painting_shape_rendering_crisp_edges_on_circle() {assert_eq!(run_test("resvg/painting/shape-rendering/crispEdges-on-circle"), 0)}
...
#[test] fn resvg_painting_fill_hash_rrggbb_uppercase_color() {assert_eq!(run_test("resvg/painting/fill/#RRGGBB-uppercase-color"), 0)}
#[test] fn resvg_painting_fill_hash_rgb_color() {assert_eq!(run_test("resvg/painting/fill/#RGB-color"), 0)}
...
#[test] fn resvg_painting_fill_func_iri_to_a_missing_element_with_a_none_fallback() {assert_eq!(run_test("resvg/painting/fill/funcIRI-to-a-missing-element-with-a-none-fallback"), 0)}
#[test] fn resvg_painting_fill_inherit_without_parent() {assert_eq!(run_test("resvg/painting/fill/inherit-without-parent"), 0)}
#[test] fn resvg_painting_fill_valid_func_iri_with_a_fallback_icc_color() {assert_eq!(run_test("resvg/painting/fill/valid-FuncIRI-with-a-fallback-ICC-color"), 0)}
...
#[test] fn resvg_painting_fill_hash_rgba() {assert_eq!(run_test("resvg/painting/fill/#RGBA"), 0)}
...
#[test] fn resvg_painting_fill_missing_func_iri_with_a_current_color_fallback() {assert_eq!(run_test("resvg/painting/fill/missing-FuncIRI-with-a-currentColor-fallback"), 0)}
...
#[test] fn resvg_painting_fill_current_color_without_parent() {assert_eq!(run_test("resvg/painting/fill/currentColor-without-parent"), 0)}
#[test] fn resvg_painting_fill_func_iri_to_an_invalid_element_with_a_none_fallback() {assert_eq!(run_test("resvg/painting/fill/funcIRI-to-an-invalid-element-with-a-none-fallback"), 0)}
#[test] fn resvg_painting_fill_named_color() {assert_eq!(run_test("resvg/painting/fill/named-color"), 0)}
#[test] fn resvg_painting_fill_invalid_hash_rrggbb_3() {assert_eq!(run_test("resvg/painting/fill/invalid-#RRGGBB-3"), 0)}
...
#[test] fn resvg_painting_fill_invalid_hash_rrggbb_2() {assert_eq!(run_test("resvg/painting/fill/invalid-#RRGGBB-2"), 0)}
...
#[test] fn resvg_painting_fill_invalid_func_iri_with_a_fallback_color() {assert_eq!(run_test("resvg/painting/fill/invalid-FuncIRI-with-a-fallback-color"), 0)}
#[test] fn resvg_painting_fill_invalid_hash_rrggbb_1() {assert_eq!(run_test("resvg/painting/fill/invalid-#RRGGBB-1"), 0)}
#[test] fn resvg_painting_fill_invalid_func_iri_with_a_current_color_fallback() {assert_eq!(run_test("resvg/painting/fill/invalid-FuncIRI-with-a-currentColor-fallback"), 0)}
...
#[test] fn resvg_painting_fill_current_color() {assert_eq!(run_test("resvg/painting/fill/currentColor"), 0)}
#[test] fn resvg_painting_fill_none() {assert_eq!(run_test("resvg/painting/fill/none"), 0)}
#[test] fn resvg_painting_fill_hash_rrggbb_color() {assert_eq!(run_test("resvg/painting/fill/#RRGGBB-color"), 0)}
...
#[test] fn resvg_painting_fill_hash_rrggbbaa() {assert_eq!(run_test("resvg/painting/fill/#RRGGBBAA"), 0)}
#[test] fn resvg_painting_fill_rgba_0_127_0_0_5() {assert_eq!(run_test("resvg/painting/fill/rgba-0-127-0-0.5"), 0)}
#[test] fn resvg_painting_fill_func_iri_with_a_fallback_color() {assert_eq!(run_test("resvg/painting/fill/funcIRI-with-a-fallback-color"), 0)}
...
#[test] fn resvg_painting_fill_rgba_0_127_0_1_54cbdb11() {assert_eq!(run_test("resvg/painting/fill/rgba-0-127-0-1"), 0)}
...
#[test] fn resvg_painting_fill_func_iri_to_a_missing_element_with_a_fallback_color() {assert_eq!(run_test("resvg/painting/fill/funcIRI-to-a-missing-element-with-a-fallback-color"), 0)}
...
#[test] fn resvg_painting_fill_func_iri_to_an_unsupported_element() {assert_eq!(run_test("resvg/painting/fill/funcIRI-to-an-unsupported-element"), 0)}
#[test] fn resvg_painting_stroke_opacity_with_linear_gradient() {assert_eq!(run_test("resvg/painting/stroke-opacity/with-linearGradient"), 0)}
...
#[test] fn resvg_painting_stroke_func_iri_to_unsupported_element() {assert_eq!(run_test("resvg/painting/stroke/funcIRI-to-unsupported-element"), 0)}
#[test] fn resvg_painting_stroke_gradient_with_object_bounding_box_on_shape_without_a_bbox() {assert_eq!(run_test("resvg/painting/stroke/gradient-with-objectBoundingBox-on-shape-without-a-bbox"), 0)}
#[test] fn resvg_painting_stroke_current_color_without_a_parent() {assert_eq!(run_test("resvg/painting/stroke/currentColor-without-a-parent"), 0)}
#[test] fn resvg_painting_stroke_gradient_with_object_bounding_box_on_path_without_a_bbox_1() {assert_eq!(run_test("resvg/painting/stroke/gradient-with-objectBoundingBox-on-path-without-a-bbox-1"), 0)}
#[test] fn resvg_painting_stroke_linear_gradient() {assert_eq!(run_test("resvg/painting/stroke/linear-gradient"), 0)}
#[test] fn resvg_painting_stroke_gradient_with_object_bounding_box_on_path_without_a_bbox_2() {assert_eq!(run_test("resvg/painting/stroke/gradient-with-objectBoundingBox-on-path-without-a-bbox-2"), 0)}
...
#[test] fn resvg_painting_stroke_pattern_with_object_bounding_box_on_zero_bbox_shape() {assert_eq!(run_test("resvg/painting/stroke/pattern-with-objectBoundingBox-on-zero-bbox-shape"), 0)}
#[test] fn resvg_painting_stroke_gradient_with_object_bounding_box_and_fallback_on_lines() {assert_eq!(run_test("resvg/painting/stroke/gradient-with-objectBoundingBox-and-fallback-on-lines"), 0)}
...
#[test] fn resvg_painting_stroke_pattern_with_object_bounding_box_fallback_on_zero_bbox_shape() {assert_eq!(run_test("resvg/painting/stroke/pattern-with-objectBoundingBox-fallback-on-zero-bbox-shape"), 0)}
...
#[test] fn resvg_painting_opacity_b_box_impact() {assert_eq!(run_test("resvg/painting/opacity/bBox-impact"), 0)}
...
#[test] fn resvg_painting_display_none_on_clip_path() {assert_eq!(run_test("resvg/painting/display/none-on-clipPath"), 0)}
#[test] fn resvg_painting_display_b_box_impact() {assert_eq!(run_test("resvg/painting/display/bBox-impact"), 0)}
#[test] fn resvg_painting_display_none_on_linear_gradient() {assert_eq!(run_test("resvg/painting/display/none-on-linearGradient"), 0)}
#[test] fn resvg_painting_display_none_on_tspan_2() {assert_eq!(run_test("resvg/painting/display/none-on-tspan-2"), 0)}
#[test] fn resvg_painting_fill_opacity_with_linear_gradient() {assert_eq!(run_test("resvg/painting/fill-opacity/with-linearGradient"), 0)}
...
#[test] fn resvg_painting_marker_with_invalid_marker_units() {assert_eq!(run_test("resvg/painting/marker/with-invalid-markerUnits"), 0)}
...
#[test] fn resvg_painting_marker_with_view_box_2() {assert_eq!(run_test("resvg/painting/marker/with-viewBox-2"), 0)}
...
#[test] fn resvg_painting_marker_with_marker_units_user_space_on_use() {assert_eq!(run_test("resvg/painting/marker/with-markerUnits=userSpaceOnUse"), 0)}
#[test] fn resvg_painting_marker_with_view_box_1() {assert_eq!(run_test("resvg/painting/marker/with-viewBox-1"), 0)}
...
#[test] fn resvg_painting_marker_orient_45() {assert_eq!(run_test("resvg/painting/marker/orient=-45"), 0)}
...
#[test] fn resvg_painting_marker_on_arc_to() {assert_eq!(run_test("resvg/painting/marker/on-ArcTo"), 0)}
...
#[test] fn resvg_painting_image_rendering_optimize_speed_on_svg() {assert_eq!(run_test("resvg/painting/image-rendering/optimizeSpeed-on-SVG"), 0)}
#[test] fn resvg_painting_image_rendering_on_fe_image() {assert_eq!(run_test("resvg/painting/image-rendering/on-feImage"), 0)}
#[test] fn resvg_painting_image_rendering_optimize_speed() {assert_eq!(run_test("resvg/painting/image-rendering/optimizeSpeed"), 0)}
...
#[test] fn resvg_text_alignment_baseline_two_text_path_with_middle_on_first() {assert_eq!(run_test("resvg/text/alignment-baseline/two-textPath-with-middle-on-first"), 0)}
#[test] fn resvg_text_alignment_baseline_mathematical() {assert_eq!(run_test("resvg/text/alignment-baseline/mathematical"), 0)}
#[test] fn resvg_text_alignment_baseline_middle_on_text_path() {assert_eq!(run_test("resvg/text/alignment-baseline/middle-on-textPath"), 0)}
...
#[test] fn resvg_text_letter_spacing_3_b88373b6() {assert_eq!(run_test("resvg/text/letter-spacing/-3"), 0)}
...
#[test] fn resvg_text_baseline_shift_10_e1c4e284() {assert_eq!(run_test("resvg/text/baseline-shift/-10"), 0)}
...
#[test] fn resvg_text_baseline_shift_50percent_9e7d487a() {assert_eq!(run_test("resvg/text/baseline-shift/50percent"), 0)}
...
#[test] fn resvg_text_length_adjust_vertical() {assert_eq!(run_test("resvg/text/lengthAdjust/vertical"), 0)}
#[test] fn resvg_text_length_adjust_text_on_path() {assert_eq!(run_test("resvg/text/lengthAdjust/text-on-path"), 0)}
#[test] fn resvg_text_length_adjust_spacing_and_glyphs() {assert_eq!(run_test("resvg/text/lengthAdjust/spacingAndGlyphs"), 0)}
#[test] fn resvg_text_length_adjust_with_underline() {assert_eq!(run_test("resvg/text/lengthAdjust/with-underline"), 0)}
...
#[test] fn resvg_text_word_spacing_5() {assert_eq!(run_test("resvg/text/word-spacing/-5"), 0)}
...
#[test] fn resvg_text_text_rendering_optimize_legibility() {assert_eq!(run_test("resvg/text/text-rendering/optimizeLegibility"), 0)}
#[test] fn resvg_text_text_rendering_geometric_precision() {assert_eq!(run_test("resvg/text/text-rendering/geometricPrecision"), 0)}
...
#[test] fn resvg_text_text_rendering_optimize_speed() {assert_eq!(run_test("resvg/text/text-rendering/optimizeSpeed"), 0)}
...
#[test] fn resvg_text_text_length_zero() {assert_eq!(run_test("resvg/text/textLength/zero"), 0)}
#[test] fn resvg_text_text_length_150_on_parent() {assert_eq!(run_test("resvg/text/textLength/150-on-parent"), 0)}
#[test] fn resvg_text_text_length_on_a_single_tspan() {assert_eq!(run_test("resvg/text/textLength/on-a-single-tspan"), 0)}
#[test] fn resvg_text_text_length_75percent() {assert_eq!(run_test("resvg/text/textLength/75percent"), 0)}
#[test] fn resvg_text_text_length_arabic() {assert_eq!(run_test("resvg/text/textLength/arabic"), 0)}
#[test] fn resvg_text_text_length_150() {assert_eq!(run_test("resvg/text/textLength/150"), 0)}
#[test] fn resvg_text_text_length_arabic_with_length_adjust() {assert_eq!(run_test("resvg/text/textLength/arabic-with-lengthAdjust"), 0)}
#[test] fn resvg_text_text_length_150_on_tspan() {assert_eq!(run_test("resvg/text/textLength/150-on-tspan"), 0)}
#[test] fn resvg_text_text_length_inherit() {assert_eq!(run_test("resvg/text/textLength/inherit"), 0)}
#[test] fn resvg_text_text_length_on_text_and_tspan() {assert_eq!(run_test("resvg/text/textLength/on-text-and-tspan"), 0)}
#[test] fn resvg_text_text_length_negative() {assert_eq!(run_test("resvg/text/textLength/negative"), 0)}
#[test] fn resvg_text_text_length_40mm() {assert_eq!(run_test("resvg/text/textLength/40mm"), 0)}
...
#[test] fn resvg_text_text_decoration_with_text_length_on_a_single_character() {assert_eq!(run_test("resvg/text/text-decoration/with-textLength-on-a-single-character"), 0)}
#[test] fn resvg_text_text_path_invalid_text_path_in_the_middle() {assert_eq!(run_test("resvg/text/textPath/invalid-textPath-in-the-middle"), 0)}
#[test] fn resvg_text_text_path_spacing_auto() {assert_eq!(run_test("resvg/text/textPath/spacing=auto"), 0)}
#[test] fn resvg_text_text_path_with_letter_spacing() {assert_eq!(run_test("resvg/text/textPath/with-letter-spacing"), 0)}
#[test] fn resvg_text_text_path_with_invalid_path_and_xlink_href() {assert_eq!(run_test("resvg/text/textPath/with-invalid-path-and-xlink-href"), 0)}
#[test] fn resvg_text_text_path_link_to_rect() {assert_eq!(run_test("resvg/text/textPath/link-to-rect"), 0)}
#[test] fn resvg_text_text_path_dy_with_tiny_coordinates() {assert_eq!(run_test("resvg/text/textPath/dy-with-tiny-coordinates"), 0)}
#[test] fn resvg_text_text_path_with_path() {assert_eq!(run_test("resvg/text/textPath/with-path"), 0)}
#[test] fn resvg_text_text_path_with_filter() {assert_eq!(run_test("resvg/text/textPath/with-filter"), 0)}
#[test] fn resvg_text_text_path_complex() {assert_eq!(run_test("resvg/text/textPath/complex"), 0)}
#[test] fn resvg_text_text_path_invalid_link() {assert_eq!(run_test("resvg/text/textPath/invalid-link"), 0)}
#[test] fn resvg_text_text_path_mixed_children_2() {assert_eq!(run_test("resvg/text/textPath/mixed-children-2"), 0)}
#[test] fn resvg_text_text_path_start_offset_9999() {assert_eq!(run_test("resvg/text/textPath/startOffset=9999"), 0)}
#[test] fn resvg_text_text_path_mixed_children_1() {assert_eq!(run_test("resvg/text/textPath/mixed-children-1"), 0)}
#[test] fn resvg_text_text_path_nested() {assert_eq!(run_test("resvg/text/textPath/nested"), 0)}
#[test] fn resvg_text_text_path_with_transform_outside_a_referenced_path() {assert_eq!(run_test("resvg/text/textPath/with-transform-outside-a-referenced-path"), 0)}
#[test] fn resvg_text_text_path_with_text_anchor() {assert_eq!(run_test("resvg/text/textPath/with-text-anchor"), 0)}
#[test] fn resvg_text_text_path_writing_mode_tb() {assert_eq!(run_test("resvg/text/textPath/writing-mode=tb"), 0)}
#[test] fn resvg_text_text_path_with_big_letter_spacing() {assert_eq!(run_test("resvg/text/textPath/with-big-letter-spacing"), 0)}
#[test] fn resvg_text_text_path_path_with_close_path() {assert_eq!(run_test("resvg/text/textPath/path-with-ClosePath"), 0)}
#[test] fn resvg_text_text_path_simple_case() {assert_eq!(run_test("resvg/text/textPath/simple-case"), 0)}
#[test] fn resvg_text_text_path_path_with_subpaths_and_start_offset() {assert_eq!(run_test("resvg/text/textPath/path-with-subpaths-and-startOffset"), 0)}
#[test] fn resvg_text_text_path_method_stretch() {assert_eq!(run_test("resvg/text/textPath/method=stretch"), 0)}
#[test] fn resvg_text_text_path_with_path_and_xlink_href() {assert_eq!(run_test("resvg/text/textPath/with-path-and-xlink-href"), 0)}
#[test] fn resvg_text_text_path_no_link() {assert_eq!(run_test("resvg/text/textPath/no-link"), 0)}
#[test] fn resvg_text_text_path_with_coordinates_on_text() {assert_eq!(run_test("resvg/text/textPath/with-coordinates-on-text"), 0)}
#[test] fn resvg_text_text_path_m_a_path() {assert_eq!(run_test("resvg/text/textPath/m-A-path"), 0)}
#[test] fn resvg_text_text_path_closed_path() {assert_eq!(run_test("resvg/text/textPath/closed-path"), 0)}
#[test] fn resvg_text_text_path_with_baseline_shift() {assert_eq!(run_test("resvg/text/textPath/with-baseline-shift"), 0)}
#[test] fn resvg_text_text_path_with_baseline_shift_and_rotate() {assert_eq!(run_test("resvg/text/textPath/with-baseline-shift-and-rotate"), 0)}
#[test] fn resvg_text_text_path_very_long_text() {assert_eq!(run_test("resvg/text/textPath/very-long-text"), 0)}
#[test] fn resvg_text_text_path_start_offset_5mm() {assert_eq!(run_test("resvg/text/textPath/startOffset=5mm"), 0)}
#[test] fn resvg_text_text_path_with_underline() {assert_eq!(run_test("resvg/text/textPath/with-underline"), 0)}
#[test] fn resvg_text_text_path_tspan_with_absolute_position() {assert_eq!(run_test("resvg/text/textPath/tspan-with-absolute-position"), 0)}
#[test] fn resvg_text_text_path_start_offset_10percent() {assert_eq!(run_test("resvg/text/textPath/startOffset=10percent"), 0)}
#[test] fn resvg_text_text_path_side_right() {assert_eq!(run_test("resvg/text/textPath/side=right"), 0)}
#[test] fn resvg_text_text_path_with_rotate() {assert_eq!(run_test("resvg/text/textPath/with-rotate"), 0)}
#[test] fn resvg_text_text_path_m_l_z_path() {assert_eq!(run_test("resvg/text/textPath/m-L-Z-path"), 0)}
#[test] fn resvg_text_text_path_with_transform_on_a_referenced_path() {assert_eq!(run_test("resvg/text/textPath/with-transform-on-a-referenced-path"), 0)}
#[test] fn resvg_text_text_path_path_with_subpaths() {assert_eq!(run_test("resvg/text/textPath/path-with-subpaths"), 0)}
#[test] fn resvg_text_text_path_with_coordinates_on_text_path() {assert_eq!(run_test("resvg/text/textPath/with-coordinates-on-textPath"), 0)}
#[test] fn resvg_text_text_path_start_offset_100() {assert_eq!(run_test("resvg/text/textPath/startOffset=-100"), 0)}
#[test] fn resvg_text_text_path_two_paths() {assert_eq!(run_test("resvg/text/textPath/two-paths"), 0)}
#[test] fn resvg_text_text_path_start_offset_30() {assert_eq!(run_test("resvg/text/textPath/startOffset=30"), 0)}
#[test] fn resvg_text_text_path_tspan_with_relative_position() {assert_eq!(run_test("resvg/text/textPath/tspan-with-relative-position"), 0)}
...
#[test] fn resvg_structure_svg_preserve_aspect_ratio_x_min_ymin() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=xMinYMin"), 0)}
#[test] fn resvg_structure_svg_nested_svg_with_rect_and_view_box_2() {assert_eq!(run_test("resvg/structure/svg/nested-svg-with-rect-and-viewBox-2"), 0)}
#[test] fn resvg_structure_svg_nested_svg_with_rect_and_view_box_3() {assert_eq!(run_test("resvg/structure/svg/nested-svg-with-rect-and-viewBox-3"), 0)}
#[test] fn resvg_structure_svg_no_children() {assert_eq!(run_test("resvg/structure/svg/no-children"), 0)}
#[test] fn resvg_structure_svg_nested_svg_with_rect_and_view_box_1() {assert_eq!(run_test("resvg/structure/svg/nested-svg-with-rect-and-viewBox-1"), 0)}
#[test] fn resvg_structure_svg_func_iri_with_invalid_characters() {assert_eq!(run_test("resvg/structure/svg/funcIRI-with-invalid-characters"), 0)}
...
#[test] fn resvg_structure_svg_preserve_aspect_ratio_x_max_ymax_slice() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=xMaxYMax-slice"), 0)}
...
#[test] fn resvg_structure_svg_view_box_not_at_zero_pos() {assert_eq!(run_test("resvg/structure/svg/viewBox-not-at-zero-pos"), 0)}
#[test] fn resvg_structure_svg_preserve_aspect_ratio_x_max_ymax() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=xMaxYMax"), 0)}
...
#[test] fn resvg_structure_svg_func_iri_with_quotes() {assert_eq!(run_test("resvg/structure/svg/funcIRI-with-quotes"), 0)}
...
#[test] fn resvg_structure_svg_preserve_aspect_ratio_x_mid_ymid() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=xMidYMid"), 0)}
#[test] fn resvg_structure_svg_proportional_view_box() {assert_eq!(run_test("resvg/structure/svg/proportional-viewBox"), 0)}
// invalid size
#[ignore] #[test] fn resvg_structure_svg_no_size() {assert_eq!(run_test("resvg/structure/svg/no-size"), 0)}
#[test] fn resvg_structure_svg_preserve_aspect_ratio_x_mid_ymid_slice() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=xMidYMid-slice"), 0)}
#[test] fn resvg_structure_svg_preserve_aspect_ratio_x_min_ymin_slice() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=xMinYMin-slice"), 0)}
// invalid encoding
#[ignore] #[test] fn resvg_structure_svg_not_utf_8_encoding() {assert_eq!(run_test("resvg/structure/svg/not-UTF-8-encoding"), 0)}
#[test] fn resvg_structure_svg_preserve_aspect_ratio_none() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio=none"), 0)}
...
#[test] fn resvg_structure_svg_func_iri_parsing() {assert_eq!(run_test("resvg/structure/svg/funcIRI-parsing"), 0)}
...
#[test] fn resvg_structure_svg_nested_svg_with_view_box() {assert_eq!(run_test("resvg/structure/svg/nested-svg-with-viewBox"), 0)}
#[test] fn resvg_structure_svg_nested_svg_one_with_rect_and_one_with_view_box() {assert_eq!(run_test("resvg/structure/svg/nested-svg-one-with-rect-and-one-with-viewBox"), 0)}
...
#[test] fn resvg_structure_svg_nested_svg_with_view_box_and_percent_values() {assert_eq!(run_test("resvg/structure/svg/nested-svg-with-viewBox-and-percent-values"), 0)}
#[test] fn resvg_structure_svg_nested_svg_with_rect_and_view_box_and_percent_values() {assert_eq!(run_test("resvg/structure/svg/nested-svg-with-rect-and-viewBox-and-percent-values"), 0)}
...
#[test] fn resvg_structure_svg_preserve_aspect_ratio_with_view_box_not_at_zero_pos() {assert_eq!(run_test("resvg/structure/svg/preserveAspectRatio-with-viewBox-not-at-zero-pos"), 0)}
#[test] fn resvg_structure_system_language_on_svg() {assert_eq!(run_test("resvg/structure/systemLanguage/on-svg"), 0)}
#[test] fn resvg_structure_system_language_on_defs() {assert_eq!(run_test("resvg/structure/systemLanguage/on-defs"), 0)}
#[test] fn resvg_structure_system_language_en_gb() {assert_eq!(run_test("resvg/structure/systemLanguage/en-GB"), 0)}
#[test] fn resvg_structure_system_language_en() {assert_eq!(run_test("resvg/structure/systemLanguage/en"), 0)}
#[test] fn resvg_structure_system_language_on_clip_path() {assert_eq!(run_test("resvg/structure/systemLanguage/on-clipPath"), 0)}
#[test] fn resvg_structure_system_language_en_us() {assert_eq!(run_test("resvg/structure/systemLanguage/en-US"), 0)}
#[test] fn resvg_structure_system_language_on_tspan() {assert_eq!(run_test("resvg/structure/systemLanguage/on-tspan"), 0)}
#[test] fn resvg_structure_system_language_on_linear_gradient() {assert_eq!(run_test("resvg/structure/systemLanguage/on-linearGradient"), 0)}
#[test] fn resvg_structure_system_language_ru_en() {assert_eq!(run_test("resvg/structure/systemLanguage/ru-en"), 0)}
#[test] fn resvg_structure_system_language_ru_ru() {assert_eq!(run_test("resvg/structure/systemLanguage/ru-Ru"), 0)}
...
#[test] fn resvg_structure_style_i_d_selector() {assert_eq!(run_test("resvg/structure/style/iD-selector"), 0)}
...
#[test] fn resvg_structure_symbol_with_view_box() {assert_eq!(run_test("resvg/structure/symbol/with-viewBox"), 0)}
...
#[test] fn resvg_structure_symbol_opacity_on_symbol_with_view_box() {assert_eq!(run_test("resvg/structure/symbol/opacity-on-symbol-with-viewBox"), 0)}
#[test] fn resvg_structure_symbol_with_view_box_and_custom_use_size() {assert_eq!(run_test("resvg/structure/symbol/with-viewBox-and-custom-use-size"), 0)}
...
#[test] fn resvg_structure_symbol_with_view_box_and_custom_use_rect() {assert_eq!(run_test("resvg/structure/symbol/with-viewBox-and-custom-use-rect"), 0)}
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_max_ymax_meet() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMaxYMax-meet"), 0)}
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_mid_ymid_meet() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMidYMid-meet"), 0)}
// no relative paths supported
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_mid_ymid_meet_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMidYMid-meet-on-svg"), 0)}
// no relative paths supported
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_min_ymin_slice_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMinYMin-slice-on-svg"), 0)}
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_max_ymax_slice() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMaxYMax-slice"), 0)}
// no relative paths supported
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_mid_ymid_slice_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMidYMid-slice-on-svg"), 0)}
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_min_ymin_meet() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMinYMin-meet"), 0)}
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_max_ymax_meet_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMaxYMax-meet-on-svg"), 0)}
#[test] fn resvg_structure_image_preserve_aspect_ratio_none_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=none-on-svg"), 0)}
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_mid_ymid_slice() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMidYMid-slice"), 0)}
// no relative paths supported
#[ignore] #[test] fn resvg_structure_image_recursive_1() {assert_eq!(run_test("resvg/structure/image/recursive-1"), 0)}
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_min_ymin_slice() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMinYMin-slice"), 0)}
#[test] fn resvg_structure_image_preserve_aspect_ratio_none() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=none"), 0)}
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_min_ymin_meet_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMinYMin-meet-on-svg"), 0)}
// no relative paths supported
...
#[test] fn resvg_structure_image_preserve_aspect_ratio_x_max_ymax_slice_on_svg() {assert_eq!(run_test("resvg/structure/image/preserveAspectRatio=xMaxYMax-slice-on-svg"), 0)}
...
#[test] fn resvg_structure_use_c_ss_rules() {assert_eq!(run_test("resvg/structure/use/cSS-rules"), 0)}
...
#[test] fn resvg_structure_use_with_current_color() {assert_eq!(run_test("resvg/structure/use/with-currentColor"), 0)}
...
#[test] fn resvg_structure_use_xlink_to_svg_element_with_view_box() {assert_eq!(run_test("resvg/structure/use/xlink-to-svg-element-with-viewBox"), 0)}
...
#[test] fn resvg_structure_switch_system_language_en_us() {assert_eq!(run_test("resvg/structure/switch/systemLanguage=en-US"), 0)}
#[test] fn resvg_structure_switch_required_features() {assert_eq!(run_test("resvg/structure/switch/requiredFeatures"), 0)}
...
#[test] fn resvg_structure_switch_system_language_en_gb() {assert_eq!(run_test("resvg/structure/switch/systemLanguage=en-GB"), 0)}
...
#[test] fn resvg_structure_switch_system_language_en() {assert_eq!(run_test("resvg/structure/switch/systemLanguage=en"), 0)}
#[test] fn resvg_structure_switch_simple_case() {assert_eq!(run_test("resvg/structure/switch/simple-case"), 0)}
#[test] fn resvg_structure_switch_system_language() {assert_eq!(run_test("resvg/structure/switch/systemLanguage"), 0)}
#[test] fn resvg_structure_switch_system_language_ru_ru() {assert_eq!(run_test("resvg/structure/switch/systemLanguage=ru-Ru"), 0)}
#[test] fn resvg_structure_switch_system_language_ru_en() {assert_eq!(run_test("resvg/structure/switch/systemLanguage=ru-en"), 0)}
...
#[test] fn resvg_structure_transform_origin_on_clippath_object_bounding_box() {assert_eq!(run_test("resvg/structure/transform-origin/on-clippath-objectBoundingBox"), 0)}
...
#[test] fn resvg_structure_transform_skew_y() {assert_eq!(run_test("resvg/structure/transform/skewY"), 0)}
#[test] fn resvg_structure_transform_rotate() {assert_eq!(run_test("resvg/structure/transform/rotate"), 0)}
#[test] fn resvg_structure_transform_skew_x() {assert_eq!(run_test("resvg/structure/transform/skewX"), 0)}
...
#[test] fn resvg_masking_clip_path_with_marker_on_clip() {assert_eq!(run_test("resvg/masking/clipPath/with-marker-on-clip"), 0)}
#[test] fn resvg_masking_clip_path_mixed_clip_rule() {assert_eq!(run_test("resvg/masking/clipPath/mixed-clip-rule"), 0)}
#[test] fn resvg_masking_clip_path_circle_shorthand() {assert_eq!(run_test("resvg/masking/clipPath/circle-shorthand"), 0)}
#[test] fn resvg_masking_clip_path_clip_rule_evenodd() {assert_eq!(run_test("resvg/masking/clipPath/clip-rule=evenodd"), 0)}
#[test] fn resvg_masking_clip_path_switch_is_not_a_valid_child() {assert_eq!(run_test("resvg/masking/clipPath/switch-is-not-a-valid-child"), 0)}
#[test] fn resvg_masking_clip_path_g_is_not_a_valid_child() {assert_eq!(run_test("resvg/masking/clipPath/g-is-not-a-valid-child"), 0)}
#[test] fn resvg_masking_clip_path_with_invalid_child_via_use() {assert_eq!(run_test("resvg/masking/clipPath/with-invalid-child-via-use"), 0)}
#[test] fn resvg_masking_clip_path_recursive_on_child() {assert_eq!(run_test("resvg/masking/clipPath/recursive-on-child"), 0)}
#[test] fn resvg_masking_clip_path_no_children() {assert_eq!(run_test("resvg/masking/clipPath/no-children"), 0)}
#[test] fn resvg_masking_clip_path_invalid_transform_on_clip_path() {assert_eq!(run_test("resvg/masking/clipPath/invalid-transform-on-clipPath"), 0)}
#[test] fn resvg_masking_clip_path_mask_has_no_effect() {assert_eq!(run_test("resvg/masking/clipPath/mask-has-no-effect"), 0)}
#[test] fn resvg_masking_clip_path_fill_has_no_effect() {assert_eq!(run_test("resvg/masking/clipPath/fill-has-no-effect"), 0)}
#[test] fn resvg_masking_clip_path_recursive() {assert_eq!(run_test("resvg/masking/clipPath/recursive"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_on_children() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-on-children"), 0)}
#[test] fn resvg_masking_clip_path_opacity_has_no_effect() {assert_eq!(run_test("resvg/masking/clipPath/opacity-has-no-effect"), 0)}
#[test] fn resvg_masking_clip_path_invisible_child_2() {assert_eq!(run_test("resvg/masking/clipPath/invisible-child-2"), 0)}
#[test] fn resvg_masking_clip_path_multiple_children() {assert_eq!(run_test("resvg/masking/clipPath/multiple-children"), 0)}
#[test] fn resvg_masking_clip_path_on_the_root_svg_without_size() {assert_eq!(run_test("resvg/masking/clipPath/on-the-root-svg-without-size"), 0)}
#[test] fn resvg_masking_clip_path_invisible_child_1() {assert_eq!(run_test("resvg/masking/clipPath/invisible-child-1"), 0)}
#[test] fn resvg_masking_clip_path_transform_on_clip_path() {assert_eq!(run_test("resvg/masking/clipPath/transform-on-clipPath"), 0)}
#[test] fn resvg_masking_clip_path_on_a_horizontal_line() {assert_eq!(run_test("resvg/masking/clipPath/on-a-horizontal-line"), 0)}
#[test] fn resvg_masking_clip_path_invalid_clip_path_on_self() {assert_eq!(run_test("resvg/masking/clipPath/invalid-clip-path-on-self"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_on_child() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-on-child"), 0)}
#[test] fn resvg_masking_clip_path_circle_shorthand_with_view_box() {assert_eq!(run_test("resvg/masking/clipPath/circle-shorthand-with-view-box"), 0)}
#[test] fn resvg_masking_clip_path_clipping_with_complex_text_and_clip_rule() {assert_eq!(run_test("resvg/masking/clipPath/clipping-with-complex-text-and-clip-rule"), 0)}
#[test] fn resvg_masking_clip_path_simple_case() {assert_eq!(run_test("resvg/masking/clipPath/simple-case"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_units_object_bounding_box() {assert_eq!(run_test("resvg/masking/clipPath/clipPathUnits=objectBoundingBox"), 0)}
#[test] fn resvg_masking_clip_path_with_use_child() {assert_eq!(run_test("resvg/masking/clipPath/with-use-child"), 0)}
#[test] fn resvg_masking_clip_path_clipping_with_text() {assert_eq!(run_test("resvg/masking/clipPath/clipping-with-text"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_with_transform_on_text() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-with-transform-on-text"), 0)}
#[test] fn resvg_masking_clip_path_malformed_path_child() {assert_eq!(run_test("resvg/masking/clipPath/malformed-path-child"), 0)}
#[test] fn resvg_masking_clip_path_line_is_not_a_valid_child() {assert_eq!(run_test("resvg/masking/clipPath/line-is-not-a-valid-child"), 0)}
#[test] fn resvg_masking_clip_path_recursive_on_self() {assert_eq!(run_test("resvg/masking/clipPath/recursive-on-self"), 0)}
#[test] fn resvg_masking_clip_path_none() {assert_eq!(run_test("resvg/masking/clipPath/none"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_on_self() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-on-self"), 0)}
#[test] fn resvg_masking_clip_path_overlapped_shapes_with_evenodd() {assert_eq!(run_test("resvg/masking/clipPath/overlapped-shapes-with-evenodd"), 0)}
#[test] fn resvg_masking_clip_path_clipping_with_complex_text_2() {assert_eq!(run_test("resvg/masking/clipPath/clipping-with-complex-text-2"), 0)}
#[test] fn resvg_masking_clip_path_circle_shorthand_with_stroke_box() {assert_eq!(run_test("resvg/masking/clipPath/circle-shorthand-with-stroke-box"), 0)}
#[test] fn resvg_masking_clip_path_invalid_clip_path_on_child() {assert_eq!(run_test("resvg/masking/clipPath/invalid-clip-path-on-child"), 0)}
#[test] fn resvg_masking_clip_path_symbol_via_use_is_not_a_valid_child() {assert_eq!(run_test("resvg/masking/clipPath/symbol-via-use-is-not-a-valid-child"), 0)}
#[test] fn resvg_masking_clip_path_clip_rule_from_parent_node() {assert_eq!(run_test("resvg/masking/clipPath/clip-rule-from-parent-node"), 0)}
#[test] fn resvg_masking_clip_path_clipping_with_complex_text_1() {assert_eq!(run_test("resvg/masking/clipPath/clipping-with-complex-text-1"), 0)}
#[test] fn resvg_masking_clip_path_image_is_not_a_valid_child() {assert_eq!(run_test("resvg/masking/clipPath/image-is-not-a-valid-child"), 0)}
#[test] fn resvg_masking_clip_path_filter_has_no_effect() {assert_eq!(run_test("resvg/masking/clipPath/filter-has-no-effect"), 0)}
#[test] fn resvg_masking_clip_path_on_the_root_svg_with_size() {assert_eq!(run_test("resvg/masking/clipPath/on-the-root-svg-with-size"), 0)}
#[test] fn resvg_masking_clip_path_invalid_func_iri() {assert_eq!(run_test("resvg/masking/clipPath/invalid-FuncIRI"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_with_transform() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-with-transform"), 0)}
#[test] fn resvg_masking_clip_path_self_recursive() {assert_eq!(run_test("resvg/masking/clipPath/self-recursive"), 0)}
#[test] fn resvg_masking_clip_path_stroke_has_no_effect() {assert_eq!(run_test("resvg/masking/clipPath/stroke-has-no-effect"), 0)}
#[test] fn resvg_masking_clip_path_nested_clip_path() {assert_eq!(run_test("resvg/masking/clipPath/nested-clip-path"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_on_child_with_transform() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-on-child-with-transform"), 0)}
#[test] fn resvg_masking_clip_path_clip_path_on_self_2() {assert_eq!(run_test("resvg/masking/clipPath/clip-path-on-self-2"), 0)}
#[test] fn resvg_masking_mask_with_image() {assert_eq!(run_test("resvg/masking/mask/with-image"), 0)}
#[test] fn resvg_masking_mask_mask_units_user_space_on_use_without_rect() {assert_eq!(run_test("resvg/masking/mask/maskUnits=userSpaceOnUse-without-rect"), 0)}
#[test] fn resvg_masking_mask_recursive_on_child() {assert_eq!(run_test("resvg/masking/mask/recursive-on-child"), 0)}
#[test] fn resvg_masking_mask_mask_units_user_space_on_use_with_rect() {assert_eq!(run_test("resvg/masking/mask/maskUnits=userSpaceOnUse-with-rect"), 0)}
...
#[test] fn resvg_masking_mask_mask_units_user_space_on_use_with_percent() {assert_eq!(run_test("resvg/masking/mask/maskUnits=userSpaceOnUse-with-percent"), 0)}
...
#[test] fn resvg_masking_mask_color_interpolation_linear_rgb() {assert_eq!(run_test("resvg/masking/mask/color-interpolation=linearRGB"), 0)}
...
#[test] fn resvg_masking_mask_nested_object_bounding_box() {assert_eq!(run_test("resvg/masking/mask/nested-objectBoundingBox"), 0)}
#[test] fn resvg_masking_mask_mask_units_object_bounding_box_with_percent() {assert_eq!(run_test("resvg/masking/mask/maskUnits=objectBoundingBox-with-percent"), 0)}
#[test] fn resvg_masking_mask_simple_case() {assert_eq!(run_test("resvg/masking/mask/simple-case"), 0)}
#[test] fn resvg_masking_mask_mask_content_units_object_bounding_box() {assert_eq!(run_test("resvg/masking/mask/maskContentUnits=objectBoundingBox"), 0)}
...
#[test] fn resvg_masking_mask_invalid_func_iri() {assert_eq!(run_test("resvg/masking/mask/invalid-FuncIRI"), 0)}
...
#[test] fn resvg_masking_mask_mask_units_user_space_on_use_with_width_only() {assert_eq!(run_test("resvg/masking/mask/maskUnits=userSpaceOnUse-with-width-only"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_2() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-2"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_3() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-3"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_1() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-1"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_4() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-4"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_5() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-5"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_6() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-6"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_18() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-18"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_19() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-19"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_14() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-14"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_15() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-15"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_17() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-17"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_16() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-16"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_12() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-12"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_13() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-13"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_11() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-11"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_10() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-10"), 0)}
#[test] fn custom_paint_servers_linear_gradient_linear_gradient_9() {assert_eq!(run_test("custom/paint-servers/linearGradient/linear-gradient-9"), 0)}
...
#[test] fn custom_masking_clip_path_clip_path_with_nested_clip_path_and_transform() {assert_eq!(run_test("custom/masking/clipPath/clip-path-with-nested-clip-path-and-transform"), 0)}
#[test] fn custom_masking_clip_path_complex_clip_path_with_nested_clip_path_on_child() {assert_eq!(run_test("custom/masking/clipPath/complex-clip-path-with-nested-clip-path-on-child"), 0)}
